...
static const u32 sIntroDropsLogo_Gfx[] ALIGNED(4)       = INCBIN_U32("graphics/intro/scene_1/drops_logo.4bpp.lz");
...
static const u32 sIntro1Bg_Gfx[] ALIGNED(4)             = INCBIN_U32("graphics/intro/scene_1/bg.4bpp.lz");
...
static const u32 sIntroPokeball_Gfx[] ALIGNED(4)        = INCBIN_U32("graphics/intro/scene_3/pokeball.8bpp.lz");
...
static const u32 sIntroMisc_Gfx[] ALIGNED(4)            = INCBIN_U32("graphics/intro/scene_3/misc.4bpp.lz"); // Rayquza orb, and misc unused gfx
