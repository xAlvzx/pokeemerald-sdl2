...
const u16 gIntroCopyright_Pal[] ALIGNED(4) = INCBIN_U16("graphics/intro/copyright.gbapal");
const u32 gIntroCopyright_Gfx[] ALIGNED(4) = INCBIN_U32("graphics/intro/copyright.4bpp.lz");
